...
See [`docs/overview.md`](docs/overview.md) for architecture, ownership boundaries, and commands.
...
This produces `dist-desktop/internal-game-engine-example-0.1.0-x86_64.AppImage`.
